---
title: "如何构建SSA形式的CFG"
description: "这篇文章是关于如何从非SSA（静态单一赋值）形式的CFG（控制流图）构造出SSA形式的控制流图。这主要涉及到图论中的Dominator理论。难点在于phi函数的插入。"
lead: "这篇文章是关于如何从非SSA（静态单一赋值）形式的CFG（控制流图）构造出SSA形式的控制流图。这主要涉及到图论中的Dominator理论。难点在于phi函数的插入。"
date: 2021-04-27T00:49:08+08:00
lastmod: 2021-04-27T00:49:08+08:00
draft: false
weight: 50
